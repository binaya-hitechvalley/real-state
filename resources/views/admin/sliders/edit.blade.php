        ...
        <form action="{{ route('admin.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                    {{ $slider->image ? 'Replace Image' : 'Upload Image' }}
                    @if(!$slider->image) <span class="text-red-500">*</span> @endif
                </label>
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-blue-400 transition @error('image') border-red-500 @enderror">
                    <div class="space-y-1 text-center">
                        ...
                        <p class="text-xs text-gray-500 font-medium">Leave empty to keep current image</p>
            ...
            <div class="mb-6">
                ...
                <input type="text" 
                    name="alt_text" 
                    id="alt_text" 
                    value="{{ old('alt_text', $slider->image->alt_text ?? '') }}"
            ...
            <div class="mb-6">
                ...
                <input type="number" 
                    name="order_column" 
                    id="order_column" 
                    value="{{ old('order_column', $slider->order_column) }}"
                    min="0"
